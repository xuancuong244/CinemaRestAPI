...
//     @Query(nativeQuery = true, value= " WITH VeCountCTE AS ( SELECT MaKH,Stt_XC, COUNT(*) AS so_luong_ve " +
//             "FROM ve  GROUP BY MaKH, Stt_XC " +
...
//             "                ve.MaKH IS NOT NULL" +
//             "           GROUP BY" +
//             "               kh.ma_kh, kh.ten_kh, kh.sodt, ve_count.so_luong_ve, ve_count.Stt_XC," +
//             " phim.ten_phim, lg.phu_thu, xc.gia_xuat_chieu, chi_tiet_topping.SoLuongMua, " +
//             "topping.gia, chi_tiet_topping.idve;")
