...
//
//
//                         // Kiểm tra và lưu thông tin maKH nếu có
//                         if (data.maKH !== undefined) {
//                             const maKH = parseInt(data.maKH);
//                             if (!isNaN(maKH)) {
//                                 sessionStorage.setItem("maKH", maKH.toString());
//                                 console.log('maKH:', maKH);
//                             } else {
//                                 console.error('Invalid maKH:', data.maKH);
//                             }
//                         } else {
//                             console.error('MaKH không tồn tại trong phản hồi.');
//                         }
//
//                         checkLoggedInStatus();
//
...
//                     window.location.href = redirectUrl.href('http://localhost:8085/DynamicCinema/admin/index'); // Chuyển hướng đến trang đã được chỉ định
//                 } else if (data.role === "khach_hang") {
//                     alert("Đăng nhập thành công với quyền khách hàng");
//                     const maKH = parseInt(data.maKH);
//                     if (!isNaN(maKH)) {
...
//                     } else {
//                         console.error('MaKH không hợp lệ:', data.maKH);
//                     }
//                     // Thực hiện các hành động cho quyền khách hàng
//                     window.location.href = redirectUrl.href('http://localhost:8085/DynamicCinema/index'); // Chuyển hướng đến trang đã được chỉ định
//                 } else {
//                     alert("Đăng nhập không thành công. Kiểm tra lại thông tin đăng nhập");
//                 }
//             },
